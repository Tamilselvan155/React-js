...
const LoginPage = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=2070&q=80')",
      }}
    >
      <form className="bg-white bg-opacity-90 p-8 rounded-lg shadow-md w-full max-w-sm backdrop-blur">
        <h2 className="text-2xl font-bold mb-6 text-center">Login</h2>
        <input
          type="email"
          placeholder="Email"
