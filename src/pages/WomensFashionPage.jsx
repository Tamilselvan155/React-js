...
//   if (loading) return <p className="text-center mt-8">Loading men's fashion ♀ ...</p>;

//   return (
//     <div className="p-8 bg-gray-100 min-h-screen">
//       <h1 className="text-3xl font-bold mb-6 text-center">Women's Fashion ♀ </h1>
...
const MensFashionPage = () => {
  ...
  if (loading) return <p className="text-center mt-8">Loading Women's fashion ♂...</p>;
